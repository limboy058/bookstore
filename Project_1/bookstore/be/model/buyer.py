...
class Buyer(db_conn.DBConn):
    ...
    def payment(self, user_id: str, password: str, order_id: str) -> (int, str):
        ...
        try:
            ...
            return self.pymongo_exception_handle(e)
        except BaseException as e:
            return self.base_exception_handle(e) #这里的错误处理似乎有参数问题
        session.commit_transaction()
        session.end_session()
        return 200, "ok"
    ...
    def add_funds(self, user_id, password, add_value) -> (int, str):
        ...
        try:
            ...
            return self.base_exception_handle(e)
        session.commit_transaction()
        session.end_session()
        return 200, "ok"
...
#     print(tmp.new_order('uid1','sid1',[('bid1',1),('bid2',1)]))
